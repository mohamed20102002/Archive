    ...
    <Modal title="Handover Archives" onClose={onClose} size="lg">
      {isLoading ? (
        ...
        <div className="text-center py-12">
          ...
          <h3 className="text-lg font-medium text-gray-900 mb-1">No archives found</h3>
          <p className="text-gray-500">Export a handover to create your first archive</p>
        </div>
      ) : (
        <div className="space-y-3 max-h-[60vh] overflow-y-auto">
          {archives.map((archive) => (
            <div key={archive.id} className="card p-4 hover:bg-gray-50 transition-colors">
