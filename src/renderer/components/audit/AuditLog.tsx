...
export function AuditLog() {
  ...
  return (
    <div className="-m-6 flex flex-col h-[calc(100vh-4rem)]">
      {/* Sticky Header */}
      <div className="sticky top-0 z-10 bg-archive-light px-6 pt-6 pb-4 border-b border-gray-200 space-y-4">
        {/* Header */}
        ...
        {integrityStatus?.checked && (
          <div className={`p-4 rounded-lg border ${
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                <h4 className={`font-medium ${integrityStatus.valid ? 'text-green-800' : 'text-red-800'}`}>
                  {integrityStatus.valid
                    ? 'Audit log integrity verified'
                    : 'Integrity issues detected'
                  }
                </h4>
                <p className={`text-sm mt-1 ${integrityStatus.valid ? 'text-green-700' : 'text-red-700'}`}>
