    ...
    return (
      <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 h-full flex items-center justify-center">
        <div className="text-center px-4">
          ...
          <p className="text-gray-500 dark:text-gray-400">Select an email from the list to preview it</p>
        </div>
      </div>
    )
  }
    ...
    <>
      <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 h-full overflow-hidden flex flex-col">
        ...
        <div className="p-4 border-b border-gray-200 dark:border-gray-700">
          <div className="flex items-start justify-between gap-4 mb-4">
            <div>
              ...
              {isArchived && (
                <span className="inline-flex items-center gap-1.5 mt-1 px-2 py-0.5 bg-green-100 dark:bg-green-900/50 text-green-700 dark:text-green-300 rounded text-xs font-medium">
          ...
          <div className="space-y-2 text-sm">
            <div className="flex items-center gap-2">
              ...
              <span className="text-gray-900 dark:text-gray-100">
                ...
                {email.senderName && ' '}
                <span className="text-gray-500 dark:text-gray-400">&lt;{email.sender}&gt;</span>
              </span>
            </div>

            <div className="flex items-center gap-2">
              <span className="text-gray-500 dark:text-gray-400 w-16">To:</span>
              <span className="text-gray-900 dark:text-gray-100">{email.recipients?.join(', ')}</span>
            </div>

            {email.cc && email.cc.length > 0 && (
              <div className="flex items-center gap-2">
                <span className="text-gray-500 dark:text-gray-400 w-16">CC:</span>
                <span className="text-gray-900 dark:text-gray-100">{email.cc.join(', ')}</span>
              </div>
            )}
        ...
        <div className="flex-1 overflow-y-auto p-4 relative">
          {isLoadingDetails && (
            <div className="absolute inset-0 bg-white/80 dark:bg-gray-800/80 flex flex-col items-center justify-center z-10">
              ...
              <p className="text-sm text-gray-600 dark:text-gray-400 font-medium">Loading email content...</p>
              <style>{`
                  ...
                  {topics.map((topic) => (
                    ...
                    >
                      ...
                      <div className="min-w-0">
                        <p className="font-medium text-gray-900 dark:text-gray-100 truncate">{topic.title}</p>
                        {topic.description && (
